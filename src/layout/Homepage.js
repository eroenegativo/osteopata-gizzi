...
<div>
   ...
   category?.align === "left" ? (
   <Grid container spacing={2} margin={30} key={category.id}  className="grid-left">
      ...
      <React.Fragment>
         <Grid item xs={12} lg={6}>
            ...
            <div className="cta">
               <Button component={Link} to="/osteopatia">{category.btnText}</Button>
            </div>
            ) : null}
         </Grid>
         <Grid item xs={12} lg={6}>
   ...
   <Grid container spacing={2} margin={15} key={category.id}  className="grid-right">
      ...
      <Grid item xs={category?.xs} lg={category?.lg}>
         <Typography variant={category?.variant}>{category?.title}</Typography>
         ...
         {category.id === "contact" ? (
         <Box px={10}> 
            <a href="https://www.facebook.com/profile.php?id=100086580675450"  rel="noreferrer" target="_blank">
            <FacebookIcon sx={{ color:"#ff9ea7"}}/>
            </a>
            <a href="https://www.linkedin.com/in/claudia-gizzi-32b016202/"  rel="noreferrer" target="_blank">
            <LinkedInIcon sx={{ color:"#ff9ea7"}}/>
            </a>
            <a href="https://www.instagram.com/gizzi_claudia_do/"  rel="noreferrer" target="_blank">
            <InstagramIcon sx={{ color:"#ff9ea7"}}/>
            </a>
            <a href="https://wa.me/393427886135"  rel="noreferrer" target="_blank">
         ...
         <div className="cta">
            <Button component={Link} to="/conoscimi-meglio">{category.btnText}</Button>
         </div>
         ) : null}
         {category.btnText && category.id === "healthcare"? (
         <div className="cta">
            <Button component={Link} to="/osteopatia-pma">{category.btnText}</Button>
         </div>
         ) : null}
      </Grid>
   </Grid>
